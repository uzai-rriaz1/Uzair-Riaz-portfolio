  ...
  return (
    ...
    >
      <div className="flex flex-col-reverse md:flex-row justify-between items-center">
        {/* Left Side */}
        <div className="md:w-1/2 text-center md:text-left mt-8 md:mt-0 left-side">
          {/* Greeting */}
          ...
          {/* Resume Button */}
          <a
            href="https://drive.google.com/file/d/12me5-WSNHihEUW-VsYqP_m29TGRguCJ9/view?usp=sharing"
            target="_blank"
        ...
        <div className="md:w-1/2 flex justify-center md:justify-end">
          <Tilt
            className="w-48 h-48 sm:w-64 sm:h-64 md:w-[30rem] md:h-[23rem] border-4 border-purple-700 rounded-full"
            tiltMaxAngleX={20}
            tiltMaxAngleY={20}
            perspective={1000}
            scale={1.05}
